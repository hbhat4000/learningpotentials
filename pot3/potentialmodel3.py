...
qdat = np.transpose(f['r'],(0,2,1))[201:301,:800,:]
pdat = np.transpose(f['v'],(0,2,1))[201:301,:800,:]

# remember momentum = mass * velocity
# so we must set mass of second particle
pdat[:,:,3:] *= 0.5
...
depth = 8
numneurons = [16, 16, 16, 16, 16, 16, 16, 16]
...
with tf.Session() as sess:
    init.run()
    saver.restore(sess, "./pot3_2_model_final.ckpt")
    maxsteps = 500000
    # batches = 80
    ...
    save_path = saver.save(sess, "./pot3_3_model_final.ckpt")
